// index.js
const {base,idVerify}  = require('../../api/index.js')
...
nameInput(e){
    this.setData({
        needVerifyPerson: e.detail.value
    })
},
// 出生日期选择
bindDateChange(e){
...
registerInput(e){
    this.setData({
        domicileAddress: e.detail.value
    })
},
//   文件上传
...
//   提交
  doSubmit:function(e){
    ...
    idVerify({
      needVerifyPerson: _this.data.needVerifyPerson,
      birthday: _this.data.birthday,
      desc: _this.data.miaoshu,//委托方及特别需求
      domicileAddress: _this.data.domicileAddress,
    }).then(res=>{
      wx.hideLoading({
        success: (res) => {},
      })
