...
//   提交
  doSubmit:function(e){
    ...
    legalCreate({
      clueType: _this.data.typeList[_this.data.typeIndex].itemValue,
      belongType: _this.data.industryList[_this.data.industryIndex].itemValue,
      bgDesc: _this.data.background_content,
      desc: _this.data.miaoshu,//委托方及特别需求
      fileUrl: _this.data.fileUrl,
      picList: _this.data.picList,
      source: 0, //0: 合同审查 1: 企业合规预警 2: 法律文书
    }).then(res=>{
      wx.hideLoading({
        success: (res) => {},
      })
